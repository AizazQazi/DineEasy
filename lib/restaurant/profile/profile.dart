...
class Profile extends StatefulWidget {
  Profile({required this.name, required this.token, Key? key}) : super(key: key);
  final String token;
  String name;
...
class ProfileState extends State<Profile> {
  ...
  TextEditingController _useriban = TextEditingController();
  TextEditingController _userservices = TextEditingController();
  ...
  void fetchProfileData() async {
    try {
      ...
      final response = await http.post(
        Uri.parse("https://sparkling-sarong-bass.cyclic.app/signin/restaurant/profile"),
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          _useriban.text=_profileData!["iban"];
          _userservices.text=_profileData!["services"];
          _isEditing = false;
  ...
  void _updateProfile() async {
    ...
    if (_useriban.text != _profileData?["iban"]) {
      updatedData["iban"] = _useriban.text;
    }

    if (_userservices.text != _profileData?["services"]) {
      updatedData["services"] = _userservices.text;
    }
    ...
    try {
      final response = await http.put(
        Uri.parse("https://sparkling-sarong-bass.cyclic.app/signin/restaurant/update_profile"),
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8',
        },
...
>>>>>>> origin/master
  ...
  void _onItemTapped(int index) {
    print("name before going to other screen:::${widget.name}");
    setState(() {
      _isEditing = false;
...
>>>>>>> origin/master
                ...
                Text(_profileData!["iban"],style: const TextStyle(color: Colors.white),),
<<<<<<< HEAD
                const Divider(
                  thickness: 2,
                  color: Colors.white,
...
>>>>>>> origin/master
                ...
                Text(_profileData!["services"],style: const TextStyle(color: Colors.white),),
<<<<<<< HEAD
                const Divider(
                  thickness: 2,
                  color: Colors.white,
